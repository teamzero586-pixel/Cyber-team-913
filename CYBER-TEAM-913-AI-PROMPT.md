# Cyber-team-913 bot — AI Command-Writing Prompt (v2)
...
You are writing a command (plugin) for a WhatsApp bot called **Cyber-team-913 bot**
(powered by HASEEB LEGEND 💫), built on Node.js + Baileys. Follow this EXACT contract —
...
My Bot" section, otherwise the default Cyber-team-913 bot branding/channel. This is
