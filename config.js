...
module.exports = {
     ...
     * @type {string}
     */
    BOT_NAME: process.env.BOT_NAME || 'Cyber-team-913 bot',

    /**
     * @description Owner name
     * @type {string}
     */
    OWNER_NAME: process.env.OWNER_NAME || 'HASEEB LEGEND 💫',
     ...
     * @type {string}
     */
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbDdcaoKQuJKItpwSi0D',
